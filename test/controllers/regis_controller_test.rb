...
class RegisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create regi" do
    assert_difference("Regi.count") do
      post regis_url, params: { regi: { dob: @regi.dob, firstNm: @regi.firstNm, gender: @regi.gender, init: @regi.init, lastNm: @regi.lastNm } }
    end
  ...
  test "should update regi" do
    patch regi_url(@regi), params: { regi: { dob: @regi.dob, firstNm: @regi.firstNm, gender: @regi.gender, init: @regi.init, lastNm: @regi.lastNm } }
